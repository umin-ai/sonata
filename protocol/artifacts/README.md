...
Evidence written by the scripts in [`../scripts/`](../scripts/), all on Solana Devnet. [HANDOFF.md](../../HANDOFF.md) cites most of these files; each transaction in them can be opened on https://explorer.solana.com with `?cluster=devnet`.
