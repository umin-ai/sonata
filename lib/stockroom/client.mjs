...
import * as anchorModule from "@coral-xyz/anchor/dist/browser/index.js";
import { Buffer } from "buffer";
// Anchor's browser bundle expects the standard Buffer polyfill in a few paths.
globalThis.Buffer ??= Buffer;
const anchor = anchorModule.Program ? anchorModule : Reflect.get(anchorModule, "default");
